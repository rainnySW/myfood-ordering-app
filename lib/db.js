...
let localMenu = [
    ...
    { _id: 'd1', name: 'Iced Matcha', name_th: 'มัทฉะเย็น', price: 65, category: 'Drinks', image_url: '/FoodImageIcon/iced_matcha.jpg', description: 'Premium Uji matcha green tea latte.', description_th: 'ชาเขียวมัทฉะอุจิพรีเมียม' },
    { _id: 'd2', name: 'Yuzu Honey Soda', name_th: 'ยูซุน้ำผึ้งโซดา', price: 55, category: 'Drinks', image_url: '/FoodImageIcon/yuzu_honey_soda.jpg', description: 'Refreshing sparkling yuzu with sweet honey.', description_th: 'น้ำส้มยูซุโซดาผสมน้ำผึ้ง หวานอมเปรี้ยวชื่นใจ' },
    { _id: 'd3', name: 'Iced Hojicha', name_th: 'โฮจิฉะเย็น', price: 65, category: 'Drinks', image_url: '/FoodImageIcon/iced_hojicha.jpg', description: 'Roasted green tea latte, rich and smoky.', description_th: 'ชาเขียวคั่วโฮจิฉะ หอมกลิ่นคั่วเป็นเอกลักษณ์' },
    { _id: 'd4', name: 'Melon Soda', name_th: 'เมล่อนโซดา', price: 45, category: 'Drinks', image_url: '/FoodImageIcon/melon_soda.jpg', description: 'Classic vibrant Japanese melon cream soda.', description_th: 'เมล่อนโซดาญี่ปุ่น สีเขียวสดใส ซ่าชื่นใจ' },
    { _id: 'd5', name: 'Oolong Tea', name_th: 'ชาอู่หลง', price: 40, category: 'Drinks', image_url: '/FoodImageIcon/oolong_tea.jpg', description: 'Cold brewed rich golden oolong tea.', description_th: 'ชาอู่หลงสกัดเย็น หอมนุ่มลึก' },
...
export async function authenticateUser(identifier, password) {
    const checkLocal = async () => {
        const u = localUsers.find(u => u.email === identifier);
        if (!u) return { error: 'User not found' };
        const isMatch = u.password.startsWith('$2') ? await bcrypt.compare(password, u.password) : u.password === password;
